...
HA.LOCALES["enUS"] = {
    ...
    CFG_FADE_DURATION        = "Fade Duration",
    CFG_FADE_DURATION_TT     = "How long the fade animation takes (0 = instant).",
    CFG_MOUSEOVER_REVEAL     = "Mouseover Reveal",
    CFG_MOUSEOVER_REVEAL_TT  = "Temporarily show hidden frames when hovering over them with the mouse.",
    CFG_CHAT_HIDE_EDITBOX    = "Hide Chat Typing Area",
    CFG_CHAT_HIDE_EDITBOX_TT = "Also hide the chat input box at the bottom when a chat frame is hidden.",
    CFG_CHAT_SHOW_ON_ENTER   = "Show Chat on Enter",
    CFG_CHAT_SHOW_ON_ENTER_TT= "Temporarily show hidden chat frames when you press Enter to type.",
    CFG_FLOATING_BTN         = "Floating Button",
    CFG_FLOATING_BTN_TT      = "Show or hide the floating HA button on screen.",
    CFG_KEY_UNDO             = "Undo Keybind",
    CFG_KEY_UNDO_TT          = "Click to set, right-click to clear.",
    CFG_KEY_REDO             = "Redo Keybind",
    CFG_KEY_REDO_TT          = "Click to set, right-click to clear.",
    CFG_KEY_PICKER           = "Picker Keybind",
    CFG_KEY_PICKER_TT        = "Click to set, right-click to clear.",
    CFG_KEY_NONE             = "None",
    CFG_KEY_PRESS            = "Press a key...",
...
HA.LOCALES["deDE"] = {
    ...
    CFG_FADE_DURATION        = "Ausblenddauer",
    CFG_FADE_DURATION_TT     = "Wie lange die Ausblendanimation dauert (0 = sofort).",
    CFG_MOUSEOVER_REVEAL     = "Mouseover-Anzeige",
    CFG_MOUSEOVER_REVEAL_TT  = "Versteckte Frames vorübergehend anzeigen, wenn du mit der Maus darüber fährst.",
    CFG_CHAT_HIDE_EDITBOX    = "Chat-Eingabezeile verstecken",
    CFG_CHAT_HIDE_EDITBOX_TT = "Versteckt auch die Chat-Eingabezeile unten, wenn ein Chat-Frame versteckt ist.",
    CFG_CHAT_SHOW_ON_ENTER   = "Chat bei Enter anzeigen",
    CFG_CHAT_SHOW_ON_ENTER_TT= "Versteckte Chat-Frames vorübergehend anzeigen, wenn du Enter zum Tippen drückst.",
    CFG_FLOATING_BTN         = "Schwebender Button",
    CFG_FLOATING_BTN_TT      = "Den schwebenden HA-Button auf dem Bildschirm anzeigen oder verstecken.",
    CFG_KEY_UNDO             = "Rückgängig-Taste",
    CFG_KEY_UNDO_TT          = "Klicken zum Setzen, Rechtsklick zum Löschen.",
    CFG_KEY_REDO             = "Wiederherstellen-Taste",
    CFG_KEY_REDO_TT          = "Klicken zum Setzen, Rechtsklick zum Löschen.",
    CFG_KEY_PICKER           = "Picker-Taste",
    CFG_KEY_PICKER_TT        = "Klicken zum Setzen, Rechtsklick zum Löschen.",
    CFG_KEY_NONE             = "Keine",
    CFG_KEY_PRESS            = "Taste drücken...",
    CFG_EDITION_LABEL        = "Edition",
...
HA.LOCALES["frFR"] = {
    ...
    CFG_FADE_DURATION        = "Durée du fondu",
    CFG_FADE_DURATION_TT     = "Durée de l'animation de fondu (0 = instantané).",
    CFG_MOUSEOVER_REVEAL     = "Révéler au survol",
    CFG_MOUSEOVER_REVEAL_TT  = "Afficher temporairement les cadres masqués en passant la souris dessus.",
    CFG_CHAT_HIDE_EDITBOX    = "Masquer la zone de saisie",
    CFG_CHAT_HIDE_EDITBOX_TT = "Masquer aussi la zone de saisie du chat quand un cadre de chat est masqué.",
    CFG_CHAT_SHOW_ON_ENTER   = "Afficher le chat avec Entrée",
    CFG_CHAT_SHOW_ON_ENTER_TT= "Afficher temporairement les cadres de chat masqués en appuyant sur Entrée.",
    CFG_FLOATING_BTN         = "Bouton flottant",
    CFG_FLOATING_BTN_TT      = "Afficher ou masquer le bouton flottant HA à l'écran.",
    CFG_KEY_UNDO             = "Touche Annuler",
    CFG_KEY_UNDO_TT          = "Cliquez pour définir, clic droit pour effacer.",
    CFG_KEY_REDO             = "Touche Rétablir",
    CFG_KEY_REDO_TT          = "Cliquez pour définir, clic droit pour effacer.",
    CFG_KEY_PICKER           = "Touche Sélecteur",
    CFG_KEY_PICKER_TT        = "Cliquez pour définir, clic droit pour effacer.",
    CFG_KEY_NONE             = "Aucun",
    CFG_KEY_PRESS            = "Appuyez...",
...
HA.LOCALES["esES"] = {
    ...
    CFG_FADE_DURATION        = "Duración del fundido",
    CFG_FADE_DURATION_TT     = "Duración de la animación de fundido (0 = instantáneo).",
    CFG_MOUSEOVER_REVEAL     = "Mostrar al pasar",
    CFG_MOUSEOVER_REVEAL_TT  = "Mostrar temporalmente los marcos ocultos al pasar el ratón sobre ellos.",
    CFG_CHAT_HIDE_EDITBOX    = "Ocultar área de escritura",
    CFG_CHAT_HIDE_EDITBOX_TT = "Ocultar también el cuadro de entrada del chat cuando un marco de chat está oculto.",
    CFG_CHAT_SHOW_ON_ENTER   = "Mostrar chat con Enter",
    CFG_CHAT_SHOW_ON_ENTER_TT= "Mostrar temporalmente los marcos de chat ocultos al pulsar Enter para escribir.",
    CFG_FLOATING_BTN         = "Botón flotante",
    CFG_FLOATING_BTN_TT      = "Mostrar u ocultar el botón flotante HA en pantalla.",
    CFG_KEY_UNDO             = "Tecla Deshacer",
    CFG_KEY_UNDO_TT          = "Clic para asignar, clic derecho para borrar.",
    CFG_KEY_REDO             = "Tecla Rehacer",
    CFG_KEY_REDO_TT          = "Clic para asignar, clic derecho para borrar.",
    CFG_KEY_PICKER           = "Tecla Selector",
    CFG_KEY_PICKER_TT        = "Clic para asignar, clic derecho para borrar.",
    CFG_KEY_NONE             = "Ninguno",
    CFG_KEY_PRESS            = "Pulsa una tecla...",
...
HA.LOCALES["ruRU"] = {
    ...
    CFG_FADE_DURATION        = "Длительность затухания",
    CFG_FADE_DURATION_TT     = "Длительность анимации затухания (0 = мгновенно).",
    CFG_MOUSEOVER_REVEAL     = "Показ при наведении",
    CFG_MOUSEOVER_REVEAL_TT  = "Временно показывать скрытые фреймы при наведении курсора мыши.",
    CFG_CHAT_HIDE_EDITBOX    = "Скрыть поле ввода чата",
    CFG_CHAT_HIDE_EDITBOX_TT = "Также скрывать поле ввода чата при скрытии окна чата.",
    CFG_CHAT_SHOW_ON_ENTER   = "Показать чат по Enter",
    CFG_CHAT_SHOW_ON_ENTER_TT= "Временно показывать скрытый чат при нажатии Enter для ввода.",
    CFG_FLOATING_BTN         = "Плавающая кнопка",
    CFG_FLOATING_BTN_TT      = "Показать или скрыть плавающую кнопку HA на экране.",
    CFG_KEY_UNDO             = "Клавиша Отмены",
    CFG_KEY_UNDO_TT          = "Нажмите для назначения, правый клик для сброса.",
    CFG_KEY_REDO             = "Клавиша Повтора",
    CFG_KEY_REDO_TT          = "Нажмите для назначения, правый клик для сброса.",
    CFG_KEY_PICKER           = "Клавиша Выбора",
    CFG_KEY_PICKER_TT        = "Нажмите для назначения, правый клик для сброса.",
    CFG_KEY_NONE             = "Нет",
    CFG_KEY_PRESS            = "Нажмите клавишу...",
...
HA.LOCALES["itIT"] = {
    ...
    CFG_FADE_DURATION        = "Durata dissolvenza",
    CFG_FADE_DURATION_TT     = "Durata dell'animazione di dissolvenza (0 = istantaneo).",
    CFG_MOUSEOVER_REVEAL     = "Mostra al passaggio",
    CFG_MOUSEOVER_REVEAL_TT  = "Mostra temporaneamente i riquadri nascosti passando il mouse sopra di essi.",
    CFG_CHAT_HIDE_EDITBOX    = "Nascondi area di digitazione",
    CFG_CHAT_HIDE_EDITBOX_TT = "Nasconde anche la casella di inserimento della chat quando un riquadro chat è nascosto.",
    CFG_CHAT_SHOW_ON_ENTER   = "Mostra chat con Invio",
    CFG_CHAT_SHOW_ON_ENTER_TT= "Mostra temporaneamente i riquadri chat nascosti premendo Invio per scrivere.",
    CFG_FLOATING_BTN         = "Pulsante flottante",
    CFG_FLOATING_BTN_TT      = "Mostra o nascondi il pulsante flottante HA sullo schermo.",
    CFG_KEY_UNDO             = "Tasto Annulla",
    CFG_KEY_UNDO_TT          = "Clic per impostare, clic destro per cancellare.",
    CFG_KEY_REDO             = "Tasto Ripristina",
    CFG_KEY_REDO_TT          = "Clic per impostare, clic destro per cancellare.",
    CFG_KEY_PICKER           = "Tasto Selettore",
    CFG_KEY_PICKER_TT        = "Clic per impostare, clic destro per cancellare.",
    CFG_KEY_NONE             = "Nessuno",
    CFG_KEY_PRESS            = "Premi un tasto...",
