...
HA.LOCALES["enUS"] = {
    ...
    CFG_KEY_UNDO             = "Keybind: Ctrl+Z (Undo)",
    CFG_KEY_UNDO_TT          = "Enable the Ctrl+Z keyboard shortcut for undo.",
    CFG_KEY_REDO             = "Keybind: Ctrl+Y (Redo)",
    CFG_KEY_REDO_TT          = "Enable the Ctrl+Y keyboard shortcut for redo.",
    CFG_KEY_PICKER           = "Keybind: Ctrl+P (Picker)",
    CFG_KEY_PICKER_TT        = "Enable the Ctrl+P keyboard shortcut to toggle the frame picker.",
...
HA.LOCALES["deDE"] = {
    ...
    CFG_KEY_UNDO             = "Tastenkürzel: Strg+Z (Rückgängig)",
    CFG_KEY_UNDO_TT          = "Das Tastenkürzel Strg+Z zum Rückgängigmachen aktivieren.",
    CFG_KEY_REDO             = "Tastenkürzel: Strg+Y (Wiederherstellen)",
    CFG_KEY_REDO_TT          = "Das Tastenkürzel Strg+Y zum Wiederherstellen aktivieren.",
    CFG_KEY_PICKER           = "Tastenkürzel: Strg+P (Picker)",
    CFG_KEY_PICKER_TT        = "Das Tastenkürzel Strg+P zum Umschalten des Frame-Pickers aktivieren.",
    CFG_EDITION_LABEL        = "Edition",
...
HA.LOCALES["frFR"] = {
    ...
    CFG_KEY_UNDO             = "Raccourci : Ctrl+Z (Annuler)",
    CFG_KEY_UNDO_TT          = "Activer le raccourci clavier Ctrl+Z pour annuler.",
    CFG_KEY_REDO             = "Raccourci : Ctrl+Y (Rétablir)",
    CFG_KEY_REDO_TT          = "Activer le raccourci clavier Ctrl+Y pour rétablir.",
    CFG_KEY_PICKER           = "Raccourci : Ctrl+P (Sélecteur)",
    CFG_KEY_PICKER_TT        = "Activer le raccourci clavier Ctrl+P pour basculer le sélecteur de cadre.",
...
HA.LOCALES["esES"] = {
    ...
    CFG_KEY_UNDO             = "Atajo: Ctrl+Z (Deshacer)",
    CFG_KEY_UNDO_TT          = "Activar el atajo de teclado Ctrl+Z para deshacer.",
    CFG_KEY_REDO             = "Atajo: Ctrl+Y (Rehacer)",
    CFG_KEY_REDO_TT          = "Activar el atajo de teclado Ctrl+Y para rehacer.",
    CFG_KEY_PICKER           = "Atajo: Ctrl+P (Selector)",
    CFG_KEY_PICKER_TT        = "Activar el atajo de teclado Ctrl+P para alternar el selector de marco.",
...
HA.LOCALES["ruRU"] = {
    ...
    CFG_KEY_UNDO             = "Горячая клавиша: Ctrl+Z (Отмена)",
    CFG_KEY_UNDO_TT          = "Включить сочетание клавиш Ctrl+Z для отмены.",
    CFG_KEY_REDO             = "Горячая клавиша: Ctrl+Y (Повтор)",
    CFG_KEY_REDO_TT          = "Включить сочетание клавиш Ctrl+Y для повтора.",
    CFG_KEY_PICKER           = "Горячая клавиша: Ctrl+P (Выбор)",
    CFG_KEY_PICKER_TT        = "Включить сочетание клавиш Ctrl+P для переключения выбора фрейма.",
...
HA.LOCALES["itIT"] = {
    ...
    CFG_KEY_UNDO             = "Scorciatoia: Ctrl+Z (Annulla)",
    CFG_KEY_UNDO_TT          = "Abilita la scorciatoia Ctrl+Z per annullare.",
    CFG_KEY_REDO             = "Scorciatoia: Ctrl+Y (Ripristina)",
    CFG_KEY_REDO_TT          = "Abilita la scorciatoia Ctrl+Y per ripristinare.",
    CFG_KEY_PICKER           = "Scorciatoia: Ctrl+P (Selettore)",
    CFG_KEY_PICKER_TT        = "Abilita la scorciatoia Ctrl+P per attivare il selettore di riquadro.",
