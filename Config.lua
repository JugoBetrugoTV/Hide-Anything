...
HA.DEFAULTS = {
    ...
    settings = {
        ...
        mouseoverAlpha   = 0.4,
        chatHideEditBox  = false,
        chatShowOnEnter  = false,
        keybindUndo      = "CTRL-Z",    -- modifier-key, "" to disable
        keybindRedo      = "CTRL-Y",    -- modifier-key, "" to disable
        keybindPicker    = "CTRL-P",    -- modifier-key, "" to disable
